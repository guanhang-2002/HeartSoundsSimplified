...
import { addUsers, queryUsers, removeUsers, updateUsers, queryUsersVerboseName, queryUsersListDisplay, queryUsersDisplayOrder} from './service';
...
const [updatePasswordForm] = Form.useForm();
  ...
  const handleUpdate = async (value, current_id) => {
    ...
    try {
      await updateUsers(value, current_id);
      hide();
 ...
 const handlePassWordUpdate = () => {
  ...
  const base_columns = [{
            ...
            hideInForm: true,
                        ...
                        },
                      {
                             ...
                             rules: [
                                     {
                      required: true,
                      message: 'is_professional为必填项',
                     },
                             ],
                             
                             valueEnum:{"yes":"Yes","no":"NO"}
                        },
                      {
                             title: '头像',
        ...
        hideInSearch: true,
                             ...
                             initialValue: "static/images/user_protrait/portrait.jpg.jpg",
                             dataIndex: 'photo',
                             valueType: 'avatar',
                             rules: [
        ...
        renderFormItem: (_, {type, defaultRender, ...rest}, form) => {
                                      const imageUrl = form.getFieldValue('photo');
  ...
  useEffect(() => {
    queryUsersListDisplay().then(value => {
    ...
    <PageHeaderWrapper>
      <ProTable
        ...
        toolBarRender={(action, { selectedRows }) => [
          ...
          <Button type="primary" onClick={() => exportExcelAll(paramState, queryUsers, table_columns, 'user-All')}>
            <ExportOutlined /> 导出全部
          </Button>,
